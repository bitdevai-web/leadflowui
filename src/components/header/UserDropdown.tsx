...
import { clearAuthToken } from "../../service/token.service";
...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 flex justify-center items-center dark:bg-gray-300 dark:text-indigo-900 bg-indigo-900 text-gray-300">
