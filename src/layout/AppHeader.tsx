...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-gray-50 border-b border-gray-100 z-99999">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-100 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border border-gray-200 rounded-lg z-99999 lg:flex lg:h-11 lg:w-11"
          ...
          <Link to="/" className="lg:hidden">
            <img className="w-[140px]" src="/images/logo/logo.png" alt="Logo" />
          </Link>
