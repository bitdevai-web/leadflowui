...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | LeadFlow - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for LeadFlow - React.js Tailwind CSS Admin Dashboard Template"
      />
